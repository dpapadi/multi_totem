...
hosts = {
    ...
    'int1'   : {'mac': '00000000005%s', 'ip': '10.0.5.%s' , 'switch': 'int1', 'nh': 1},
    'int2'   : {'mac': '00000000006%s', 'ip': '10.0.6.%s' , 'switch': 'int2', 'nh': 1},
    'int3'   : {'mac': '00000000007%s', 'ip': '10.0.7.%s' , 'switch': 'int3', 'nh': 1},
